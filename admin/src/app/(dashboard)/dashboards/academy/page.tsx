...
import WelcomeCard from '@/views/app/dashboard/academy/WelcomeCard'
import InterestedTopics from '@/views/app/dashboard/academy/InterestedTopics'
import PopularInstructors from '@/views/app/dashboard/academy/PopularInstructors'
import TopCourses from '@/views/app/dashboard/academy/TopCourses'
import UpcomingWebinar from '@/views/app/dashboard/academy/UpcomingWebinar'
import AssignmentProgress from '@/views/app/dashboard/academy/AssignmentProgress'
import CourseTable from '@/views/app/dashboard/academy/CourseTable'
