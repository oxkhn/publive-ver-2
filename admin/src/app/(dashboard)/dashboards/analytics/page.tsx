...
import ProjectsTable from '@/views/app/dashboard/analytics/ProjectsTable'

// Data Imports
import { getProfileData } from '@/app/server/actions'
import WebsiteAnalyticsSlider from '@/views/app/dashboard/analytics/WebsiteAnalyticsSlider'
import SalesOverview from '@/views/app/dashboard/analytics/SalesOverview'
import EarningReports from '@/views/app/dashboard/analytics/EarningReports'
import SupportTracker from '@/views/app/dashboard/analytics/SupportTracker'
import SalesByCountries from '@/views/app/dashboard/analytics/SalesByCountries'
import TotalEarning from '@/views/app/dashboard/analytics/TotalEarning'
import MonthlyCampaignState from '@/views/app/dashboard/analytics/MonthlyCampaignState'
import SourceVisits from '@/views/app/dashboard/analytics/SourceVisits'
import LineAreaDailySalesChart from '@/views/app/dashboard/analytics/LineAreaDailySalesChart'
