...
import LogisticsStatisticsCard from '@/views/app/dashboard/logistics/LogisticsStatisticsCard'
import LogisticsVehicleOverview from '@/views/app/dashboard/logistics/LogisticsVehicleOverview'
import LogisticsShipmentStatistics from '@/views/app/dashboard/logistics/LogisticsShipmentStatistics'
import LogisticsDeliveryPerformance from '@/views/app/dashboard/logistics/LogisticsDeliveryPerformance'
import LogisticsDeliveryExceptions from '@/views/app/dashboard/logistics/LogisticsDeliveryExceptions'
import LogisticsOrdersByCountries from '@/views/app/dashboard/logistics/LogisticsOrdersByCountries'
import LogisticsOverviewTable from '@/views/app/dashboard/logistics/LogisticsOverviewTable'
