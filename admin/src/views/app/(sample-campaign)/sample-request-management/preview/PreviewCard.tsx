...
const PreviewCard = ({ invoiceData }: { invoiceData?: FormRegisterAffiliateTypeWithProduct }) => {
    return (
                        ...
                        <div className='p-6 bg-actionHover rounded'>
                            <div className='flex justify-between gap-y-4 flex-col sm:flex-row'>
                                <div className='flex flex-col gap-6'>
                                    ...
                                    <div>
                                        <Typography color='text.primary'>{invoiceData?.address}</Typography>
                                        {/* <Typography color='text.primary'>San Diego County, CA 91905, USA</Typography> */}
                                        <Typography color='text.primary'>{invoiceData?.phone}</Typography>
                                    </div>
                                </div>
                                <div className='flex flex-col gap-6'>
                                    <Typography variant='h5'>{`Invoice #${invoiceData?._id}`}</Typography>
                            ...
                            <Grid item xs={12} sm={6}>
                                <div className='flex flex-col gap-4'>
                                    ...
                                    <div>
                                        ...
                                        <Typography>{invoiceData?.phone}</Typography>
                                ...
                                <tbody>
                                    {invoiceData?.products.map((item, index) => (
                                        <tr key={index}>
                                            ...
                                            <td>
                                                <Image alt='' src={item.imageList[0]} />
                                            </td>
                                            {/* <td>
