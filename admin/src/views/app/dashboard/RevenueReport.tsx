...
const barSeries = [
    { name: 'Commission Plan', data: [252, 203, 152, 173, 235, 299, 235, 252, 106] },
    { name: 'Commission Actual', data: [-128, -157, -190, -163, -89, -51, -89, -136, -190] }
]
                ...
                <Grid item xs={12} sm={4}>
                    <CardContent className='flex flex-col items-center justify-center min-bs-full gap-8'>
                        ...
                        <div className='flex flex-col items-center'>
                            <Typography variant='h3'>YTD Spend: 22,993,096,880</Typography>
                            <Typography>
                                <span className='font-medium text-textPrimary'>PO Budget: </span>30,868,407,700
                            </Typography>
                        </div>
                        <AppReactApexCharts
                            type='line'
                            ...
                            options={lineOptions}
                        />
                        <Button variant='contained'>Download Details</Button>
                    </CardContent>
                </Grid>
            </Grid>
        </Card>
