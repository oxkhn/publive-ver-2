...
const data1: DataType[] = [
    { title: 'Content Creation', value: 35, colorClass: 'text-primary' },
    { title: 'Affiliate Marketing', value: 20, colorClass: 'text-info' },
    { title: 'Personal Branding', value: 14, colorClass: 'text-success' }
]

const data2: DataType[] = [
    { title: 'Storytelling', value: 12, colorClass: 'text-secondary' },
    { title: 'Short-form Video', value: 10, colorClass: 'text-error' },
    { title: 'Data Analytics', value: 9, colorClass: 'text-warning' }
]
                                    ...
                                    <div key={i} className='flex gap-2'>
                                        <i
                                            className={classnames(
                                                'tabler-circle-filled text-xs m-[5px]',
                                                item.colorClass
                                            )}
                                        />
                                        <div>
