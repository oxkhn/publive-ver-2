    ...
    return (
        <div className='flex max-md:flex-col md:items-center gap-6 plb-6'>
            <div className='md:is-8/12'>
                ...
                <div className='mbe-4'>
                    <Typography>Keep track of your KOLs' performance and growth this week.</Typography>
                    <Typography>Boost engagement and maximize affiliate success with insightful actions!</Typography>
                </div>
                ...
                <div className='flex flex-col justify-between gap-6'>
                    ...
                    <div>
                        <Typography variant='h4' className='mbe-2'>
                            231<span className='text-textSecondary'>h</span> 14
                            <span className='text-textSecondary'>m</span>
                        </Typography>
