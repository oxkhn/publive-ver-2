...
const DialogUploadCSV = (props: Props) => {
    ...
    const { createProductViaCsv } = useProductContext()
    ...
    const handleSubmitFile = async () => {
        await createProductViaCsv(fileList[0], productListType)
        handleClose()
    }
    ...
    return (
        <Dialog open={open} fullWidth>
            ...
            <DialogContent className='flex flex-col gap-4'>
                ...
                >
                    <MenuItem value={ProductListEnum.TOP_COMMISSION}>Hoa hồng cao nhất</MenuItem>
                    <MenuItem value={ProductListEnum.HOT_DEAL}>Hot deal livestream</MenuItem>
                    <MenuItem value={ProductListEnum.TOP_SELL}>Top bán chạy</MenuItem>
                </CustomTextField>
