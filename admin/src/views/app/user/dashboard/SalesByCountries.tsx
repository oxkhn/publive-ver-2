...
const data: DataType[] = [
    {
        title: '800m',
        subtitle: '@huangandaily',
        trendNumber: 25.8,
        imgSrc: '/images/cards/us.png'
    },
    {
        title: '712m',
        subtitle: '@hannaholala',
        trendNumber: 16.2,
        trend: 'negative',
...
const SalesByCountries = () => {
    return (
        <Card>
            <CardHeader
                title='GMV by Affiliate'
                subheader='Monthly Overview'
                            ...
                            <div className='flex items-center gap-1'>
                                <i
                                    className={classnames(
                                        item.trend === 'negative'
                                            ? 'tabler-chevron-down text-error'
                                            : 'tabler-chevron-up text-success',
                                        'text-xl'
                                    )}
                                />
                                <Typography
