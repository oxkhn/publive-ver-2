...
export const SUPPORTED_FILES_EXCEL = [
  'xlsx', // Excel format (Office Open XML)
  'xls', // Excel format (older format)
  'csv', // Comma-separated values
  'xlsm', // Excel format (with macros)
  'xlsb', // Excel Binary Workbook
  'sheet', // Generic term, but typically should be more specific
];
...
export const multerOptions = {
  limits: {
    fileSize: +process.env.MAX_FILE_SIZE || 1024 * 2000,
  },
