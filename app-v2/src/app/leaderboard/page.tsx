...
import { LeaderboardProvider } from "@/views/leaderboard/LeaderboardProvider";
import CategoryAndChanel from "@/views/leaderboard/CategoryAndChanel";
import AffiliateRankings from "@/views/leaderboard/AffiliateRankings";
import CampaignRanking from "@/views/leaderboard/CampaignRanking";
...
const LeaderBoardPage = () => {
  ...
  return (
    <main className="relative mx-auto flex min-h-screen max-w-[1440px] flex-col gap-4 px-20 pb-20 pt-16 max-md:px-4">
      <LeaderboardProvider>
        <div className="shadow-card relative w-full rounded-lg pt-[130px]">
          <div className="absolute left-0 right-0 top-0 -z-10">
            <ImageKit src={Banner} className="h-[152px] w-full rounded-t-lg" />
          </div>
        </div>
        <div className="sticky top-20 z-10">
          <div className="shadow-card rounded-lg bg-white px-2 py-4">
        ...
        {tabActive == tabs[1] && <CampaignRanking />}
      </LeaderboardProvider>
    </main>
  );
};
